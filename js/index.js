	...
	*/ 
	...
	function fetchRestaurantList() {
		...
		$.each(data, function (key, val) {
			html += '<div data-role="collapsible" id=' + val.Id + '><h3>' + val.Name + ' <br>' + val.Address + ', ' + val.City + '</h3><p><img src="images/logo.jpg"></img>Base Camp is the one of the authentic Nepalese Food Palace in Helsinki operated by experienced staffs. We have been in restaurant business already for a decade and we know what dishes are suitable in Finnish taste buds. Our cuisine is prepared by very experienced chefs who had worked many years in good restaurants in Nepal and Finland.</p></div>'
		});
		IsListRefereshed = 1;
